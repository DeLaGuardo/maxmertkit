;(function ( $, window, document, undefined ) {
	...
	,	autoScroll: 15000							// im ms, if 0 – no autoscroll
	,	imageScrollInterval: 20000					// im ms, if 0 – no img scroll
	,	imageScrollAnimation: true 					// if true – animate by jquery, else – name of css animation
	...
	Carousel.prototype.init = function() {
		...
		// Set autoscroll. Always check mouseenter and mouseleave, because autoScroll can change any time.
		$me.on( 'mouseenter.' + me.name, function() {
			if( me.options.autoScroll > 0 ) clearInterval( me.timer );
		});

		$me.on( 'mouseleave.' + me.name, function() {
			if( me.options.autoScroll > 0 ) me.timer = setInterval( $.proxy(me.next, me), me.options.autoScroll );
		});
	}
