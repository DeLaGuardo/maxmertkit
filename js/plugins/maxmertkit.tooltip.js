;(function ( $, window, document, undefined ) {
	...
	$.tooltip = function( element_, options_ ) {
		...
		if( typeof $.tooltip.instanses === 'undefined' )
			$.tooltip.instanses = []
		
		if( this.element !== undefined )
			$.tooltip.instanses.push( this.element );
	...
	$.tooltip.prototype = new $.kit();
	$.tooltip.prototype.constructor = $.tooltip;

	$.tooltip.prototype._setOption = function( key_, value_ ) {
		var me  = this;
		var $me = $(me.element);
	...
	$.tooltip.prototype._open = function() {
		...
		if( me.state === 'in' ) {
			...
			if( me.options.onlyOne )
				...
				$.each( me._getOtherInstanses( $.tooltip.instanses ), function() {
	...
	$.tooltip.prototype._openAnimation = function() {
		var me  = this;
		var $me = $(me.element);
	...
	$.tooltip.prototype._closeAnimation = function() {
		var me  = this;
		var $me = $(me.element);

		if( $.easing !== undefined && (me.options.animation.split(/[ ,]+/)[1] in $.easing || me.options.animation.split(/[ ,]+/)[0] in $.easing) ) {
			console.log(me.options.animation);
			me.El.slideUp({
				duration: me.options.animationDuration,
			...
			// TODO: Create something better for css animation
			// setTimeout( function(){
			// 	me.El.hide();
			// }, .3)
		}
	...
	$.fn[_name] = function( options_ ) {
		return this.each(function() {
			if( ! $.data( this, 'kit-' + _name ) ) {
				$.data( this, 'kit-' + _name, new $.tooltip( this, options_ ) );
			}
			else {
